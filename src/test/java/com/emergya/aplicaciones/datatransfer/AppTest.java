...
public class AppTest extends TestCase {
    ...
    public void testApp(){
    	...
    	try{
    		...
    		DataTransfer.exactCopy(TestClass1.class, tc1, tc2);
    	...
    	try{
    		...
    		TestClass2 tc2 = new TestClass2();
    		DataTransfer.partialCopy(TestClass1.class, tc1, tc2);
    	...
    	try{
    		...
    		DataTransfer.customCopy(TestClass1.class, tc1, tc2, attributes);
    		//System.out.println(tc2.getId() + SEPARADOR + tc2.getLogin() + SEPARADOR + tc2.getPassword() + SEPARADOR + tc2.getNumber());
    	...
    	try{
    		...
    		TestClass2 tc2 = new TestClass2();
    		DataTransfer.completCopy(TestClass1.class, tc1, tc2);
